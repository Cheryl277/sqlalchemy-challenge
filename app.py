...
def start(start):
    ...
    start_date = []
    for minimum, maximum, average in query_results:
        start_dict = {}
        start_dict["Minimum Temperature"] = minimum
        start_dict["Maxium Temperature"] = maximum
        start_dict["Average Temperature"] = average
